 ...
 * If you are using Linux you can create a hard url instead, using the following command:
...
$requirements = array(
    ...
    array(
        'title' => 'PDO PostgreSQL extension',
        'mandatory' => false,
    ...
    // CAPTCHA:
    array(
        'title' => 'GD PHP extension with FreeType support',
        'mandatory' => false,
        'condition' => $gdOK,
    ...
    array(
        'title' => 'ImageMagick PHP extension with PNG support',
        'mandatory' => false,
        'condition' => $imagickOK,
        'by' => '<a href="http://www.yiiframework.com/doc-2.0/yii-captcha-captcha.html">Captcha</a>',
        'memo' => $imagickMemo,
